...
<template>
  ...
  border-[1px] border-light-30 dark:border-dark-60
  bg-light-10 hover:bg-light-40  active:bg-light-10 text-dark-100 dark:text-light-10 p-16px
  dark:bg-dark-70 hover:dark:bg-dark-60 active:dark:bg-dark-70">
    <div class="flex flex-row gap-16px min-h-64px">
      <slot/> <div class="nuke-text-heading-04">{{ title }}</div>
    </div>
    <div class="opacity-0 nuke-transition-expressive-standard-moderate-01 group-hover:opacity-100 h-full pt-64px flex align-bottom
    nuke-text-compact-01">
      {{ description}}
    </div>
